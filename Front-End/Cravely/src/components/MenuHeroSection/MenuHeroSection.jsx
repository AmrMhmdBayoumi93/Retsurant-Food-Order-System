      ...
      <div className='align-items-center d-flex flex-column justify-content-center my-4'>
        ...
        <div className="header d-flex flex-column">
          ...
          <h6 className={styles.h6}>
            Discover our crave-worthy selection of artisan burgers,
            handcrafted sides, and refreshing beverages tailored
            for the gourmet soul.
          </h6>

          {/* Tabs */}

          <div className='d-flex py-3 my-5 gap-4 flex-wrap'>
        ...
        <div className="container">
          <div className="row">
            ...
            {cards.map((card) => (
              ...
              <div className='col-lg-4 col-md-6 col-12 mb-5' key={card.id}>
